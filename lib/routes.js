...
module.exports = function(app, socketController) {
  ...
  var index = require('./controllers'),
      ...
      boards = require('./controllers/boards')(socketController),
  ...
  app.route('/api/users/:id')
    .get(users.show);
  app.route('/api/users/:id/picture')
    .get(users.picture);
  ...
  app.route('/api/boards/mine')
    .get(boards.mine);
  app.route('/api/boards/joinable')
    .get(middleware.auth, boards.joinableBoards);
  app.route('/api/boards/:id')
    .get(boards.show)
    .put(boards.addPost);
  app.route('/api/boards/:id/download')
    .get(boards.download);
